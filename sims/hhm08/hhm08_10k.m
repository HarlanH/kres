...
NS.cons(4) = struct('from', 'I0', 'to', 'I0', 'type', 'fixed', 'spread', 'full', 'init', 'ex');
NS.cons(5) = struct('from', 'I1', 'to', 'I1', 'type', 'fixed', 'spread', 'full', 'init', 'ex');
