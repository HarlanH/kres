...
NS.cons(3) = struct('from', 'I0', 'to', 'I0', 'type', 'fixed', 'spread', 'full', 'init', 'ex');
NS.cons(4) = struct('from', 'I1', 'to', 'I1', 'type', 'fixed', 'spread', 'full', 'init', 'ex');
NS.cons(5) = struct('from', 'I', 'to', 'E', 'type', 'exemp', 'spread', 'full', 'init', 0);
NS.cons(6) = struct('from', 'E', 'to', 'O', 'type', 'exempchl', 'spread', 'full', 'init', 'rand');
NS.cons(7) = struct('from', 'E', 'to', 'E', 'type', 'fixed', 'spread', 'full', 'init', 'in');
