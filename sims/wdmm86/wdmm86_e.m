function NS = wdmm86_e()
% Wattenmaker et al. (1986), Experiment 1, Unrelated Condition
% KRES/E
...
NS.cons(3) = struct('from', 'I', 'to', 'E', 'type', 'exemp', 'spread', 'full', 'init', 0);
NS.cons(4) = struct('from', 'E', 'to', 'O', 'type', 'exempchl', 'spread', 'full', 'init', 'rand');
NS.cons(5) = struct('from', 'E', 'to', 'E', 'type', 'fixed', 'spread', 'full', 'init', 'in');
